...
export const BurgerIngredients: FC = () => {
  ...
  const burgerIngredientsIsLoading = useSelector(
    ingredientsSliceSelectors.getIsLoading
  );
  const burgerIngredientsError = useSelector(
    ingredientsSliceSelectors.getError
  );
